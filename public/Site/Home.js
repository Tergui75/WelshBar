...
//Please note these dates are only true for 2023, you'll need to change the order every year (change the margin - 50px per day)
    function placeIt() 
    {
      if (month === 0)
      {
...
//The current day will be the one selected by default
    function presentDay() 
    {
